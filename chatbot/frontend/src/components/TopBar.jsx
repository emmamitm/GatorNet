...
export function TopBar({ children }) {
    ...
    return (
        <div className="w-full md:w-3xl flex self-center pt-4 px-4 md:pl-12 sticky top-0 z-10 bg-gradient-to-b from-white via-white to-white/0 dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-900/0">
            <div className="bg-gradient-to-b from-white via-white to-white/0 dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-900/0 via-65% pointer-events-none absolute inset-0 -bottom-5 z-[-1] blur-sm" />
